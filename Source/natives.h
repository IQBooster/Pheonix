...
namespace PED
{
	static Ped CREATE_PED(int pedType, Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Ped>(0xD49F9B0955C367DE, pedType, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0xD49F9B0955C367DE 0x0389EF71
	...
	static Ped CREATE_PED_INSIDE_VEHICLE(Vehicle vehicle, int pedType, Hash modelHash, int seat, BOOL isNetwork, BOOL thisScriptCheck) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Ped>(0x7DD959874C1FD534, vehicle, pedType, modelHash, seat, isNetwork, thisScriptCheck); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x7DD959874C1FD534 0x3000F092
...
namespace VEHICLE
{
	static Vehicle CREATE_CAR(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0xAF35D0D2583051B0 0xDD75460A
	static Vehicle CREATE_VEHICLE(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0xAF35D0D2583051B0 0xDD75460A
	...
	static Any _HAS_VEHICLE_ROCKET_BOOST(Vehicle vehicle) { return invoke<Any>(0x36D782F68B309BDA, vehicle); } // 0x36D782F68B309BDA
...
namespace OBJECT
{
	static Object CREATE_OBJECT(Object modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x509D5878EB39E842 0x2F7AA05C
	static Object CREATE_OBJECT_NO_OFFSET(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Object>(0x9A294B2138ABB884, modelHash, x, y, z, isNetwork, thisScriptCheck, dynamic); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x9A294B2138ABB884 0x58040420
	...
	static Pickup CREATE_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int p4, int value, BOOL p6, Hash modelHash) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Pickup>(0xFBA08C503DD5FA58, pickupHash, posX, posY, posZ, p4, value, p6, modelHash); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0xFBA08C503DD5FA58 0x5E14DF68
	static Pickup CREATE_PICKUP_ROTATE(Hash pickupHash, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, int flag, int amount, Any p9, BOOL p10, Hash modelHash) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Pickup>(0x891804727E0A98B7, pickupHash, posX, posY, posZ, rotX, rotY, rotZ, flag, amount, p9, p10, modelHash); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x891804727E0A98B7 0xF015BFE2
	static Pickup CREATE_AMBIENT_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int flag, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, flag, value, modelHash, returnHandle, p8); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x673966A0C0FD7171 0x17B99CE7
	static Pickup CREATE_PORTABLE_PICKUP(Hash pickupHash, float x, float y, float z, BOOL placeOnGround, Hash modelHash) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Pickup>(0x2EAF1FDB2FB55698, pickupHash, x, y, z, placeOnGround, modelHash); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x2EAF1FDB2FB55698 0x8C886BE5
	static Pickup _CREATE_PORTABLE_PICKUP_2(Hash pickupHash, float x, float y, float z, BOOL placeOnGround, Hash modelHash) { Hooking::modelSpawnBypass(true); Hooking::modelCheckBypass(true); auto returnvar = invoke<Pickup>(0x125494B98A21AAF7, pickupHash, x, y, z, placeOnGround, modelHash); Hooking::modelSpawnBypass(false); Hooking::modelCheckBypass(false); return returnvar; } // 0x125494B98A21AAF7 0x56A02502
...
namespace FIRE
{
	...
	static void ADD_OWNED_EXPLOSION(Ped ped, float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake) { Hooking::ownedExplosionBypass(true); invoke<Void>(0x172AA1B624FA1013, ped, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); Hooking::ownedExplosionBypass(false); } // 0x172AA1B624FA1013 0x27EE0D67
...
namespace UNK3
{
	...
	static BOOL _0x51F1A8E48C3D2F6SET_VEHICLE_DOORS_LOCKEDD(Any p0, BOOL p1, Any p2) { return invoke<BOOL>(0x51F1A8E48C3D2F6D, p0, p1, p2); } // 0x51F1A8E48C3D2F6D
...
namespace WATER
{
	...
	static void SET_DEEP_OCEAN_SCALER(float intensity) { invoke<Void>(0xB96B00E976BE977F, intensity); } // 0xB96B00E976BE977F
	static float GET_DEEP_OCEAN_SCALER() { return invoke<float>(0x2B2A2CC86778B619); } // 0x2B2A2CC86778B619
	static void RESET_DEEP_OCEAN_SCALER() { invoke<Void>(0x5E5E99285AE812DB); } // 0x5E5E99285AE812DB
}